...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
       ...
       # self.resizable(False, False)
        ...
        self.Description_label = customtkinter.CTkLabel(self.Description_frame, text="CustomTkinter\nLogin Page",
                                                  font=customtkinter.CTkFont(size=20, weight="bold"))
        self.Description_label.grid(row=0, column=0, padx=30, pady=(150, 15))
        self.desc_username_entry = customtkinter.CTkEntry(self.Description_frame, width=200, placeholder_text="username")
        self.desc_username_entry.grid(row=1, column=0, padx=30, pady=(15, 15))
        self.desc_password_entry = customtkinter.CTkEntry(self.Description_frame, width=200, show="*", placeholder_text="password")
        self.desc_password_entry.grid(row=2, column=0, padx=30, pady=(0, 15))
        self.desc_login_button = customtkinter.CTkButton(self.Description_frame, text="Description", command=self.login_event, width=200)
        self.desc_login_button.grid(row=3, column=0, padx=30, pady=(15, 15))
